...
def main():
    ...
    savings_maturity = int(input("How many month your savings account has to mature?"))
    ...
    cd_maturity = int(input("Enter the number of months of your CD account:"))
    ...
    # ADD YOUR CODE HERE
    print(f"Your interest earned is:${cd_interest:.2f}")
    print(f"Your updatedbBalance: ${updated_cd_balance:.2f}")
